...
impl NotificationStore {
    ...
    async fn add_notifications(
        ...
        let notifications = notifications
            ...
            // Channel invitations require ChannelStore, which is not available in this fork.
            .filter(|entry| !matches!(entry.notification, Notification::ChannelInvitation { .. }))
            .collect::<Vec<_>>();
        ...
        for entry in &notifications {
            match entry.notification {
                ...
                Notification::ChannelInvitation { .. } => continue,
            }
        }
    ...
    pub fn respond_to_notification(
        ...
        match notification {
            ...
            Notification::ChannelInvitation { .. } | Notification::ContactRequestAccepted { .. } => {}
        }
    }
}
