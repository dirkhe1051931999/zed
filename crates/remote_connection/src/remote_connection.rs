...
impl remote::RemoteClientDelegate for RemoteClientDelegate {
    ...
    fn download_server_binary_locally(
        ...
        Task::ready(Err(anyhow::anyhow!(
            "Remote server binary download is unavailable (version: {}, os: {}, arch: {})",
            version
                .as_ref()
                .map(|v| format!("{v}"))
...
/// is already established). Server binary downloads are unavailable
/// without the auto_update crate.
